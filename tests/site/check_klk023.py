...
MENU_ENUM = {"pat-cards", "pat-list", "pat-zigzag", "price-table", "tab-switch", "feature-large"}  # KLK-044/045/046: MENU §12.1.3 プール(6型)。offset0=(cards,list,zigzag)
GAL_ENUM = {"pat-grid", "pat-wide", "pat-mosaic", "pat-slider", "pat-masonry", "pat-tab-grid"}  # KLK-036/047: GALLERY §12.1.3 プール(6型)。offset0=(grid,wide,mosaic)
